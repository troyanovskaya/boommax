...
export class HomePageComponent implements OnInit {
  ...
  {url: 'assets/banner_2.jpg', title: 'banner_2'},
  {url: 'assets/banner_3.jpg', title: 'banner_3'},
  {url: 'assets/banner_4.jpg', title: 'banner_4'},
  {url: 'assets/banner_5.jpg', title: 'banner_5'}
]
  ngOnInit(){
    window.scrollTo(0, 0)
  }
